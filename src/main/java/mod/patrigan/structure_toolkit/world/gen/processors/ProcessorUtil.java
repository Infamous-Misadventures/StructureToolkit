...
public class ProcessorUtil {
    ...
    public static Random getRandom(RandomType type, BlockPos blockPos, BlockPos piecePos, BlockPos structurePos, long processorSeed){
        switch(type){
            case BLOCK: return getRandom(blockPos, processorSeed);
            case PIECE: return getRandom(piecePos, processorSeed);
            case STRUCTURE: return getRandom(structurePos, processorSeed);
